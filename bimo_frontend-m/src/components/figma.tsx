...
const ASSETS = {
  ...
  syncLog: [require("@/assets/Mask.svg"), 228, 152],
  syncClock: [require("@/assets/clock.svg"), 244, 163],
  syncPeople: [require("@/assets/time.svg"), 228, 152],
  syncUpload: [require("@/assets/upload.svg"), 228, 152],
} as const;
