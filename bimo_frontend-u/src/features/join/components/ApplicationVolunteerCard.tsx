...
const FILLED_HEART = require('../../../../assets/images/joinimg/joinheart.png');
const EMPTY_HEART = require('../../../../assets/images/joinimg/joinemptyheart.png');
    ...
    <View style={styles.wrapper}>
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          ...
          <Pressable
            accessibilityLabel={item.liked ? '찜 해제' : '찜하기'}
            ...
            <Image
              resizeMode="contain"
              source={item.liked ? FILLED_HEART : EMPTY_HEART}
              style={styles.heart}
            />
          </Pressable>
        </View>
        ...
        <View style={styles.footer}>
          ...
          {item.applied ? (
            ...
            <Pressable accessibilityRole="button" style={[styles.actionButton, styles.applyButton]}>
