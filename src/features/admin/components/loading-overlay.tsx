...
// assets/icons/vimo-logo.svg 를 네이티브에서 렌더 가능한 형태로 옮긴 컴포넌트.
// Figma가 내보낸 원본 svg는 diamond-gradient(data-figma-skip-parse)라 SvgUri로는 안 보여서
// 두 개의 반짝임(sparkle) path 를 react-native-svg 로 직접 그리고 회색 그라데이션을 입혔습니다.
function VimoLogo({ size = 120 }: { size?: number }) {
  return (
