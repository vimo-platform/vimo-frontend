...
import { completeVolunteerActivity } from '@/services/exploration/volunteer-interaction-store';

import { CalendarCircle } from '@/components/join/CalendarCircle';
import { JoinStatusButton } from '@/components/join/JoinStatusButton';
import { ParticipationLogo } from '@/components/join/ParticipationLogo';
import { ScheduleCard } from '@/components/join/ScheduleCard';
import { getMyVolunteerSchedules } from '@/services/join/api';
import {
