...
const ASSETS = {
  ...
  syncLog: [require("@/assets/Mask.png"), 228, 152],
  syncClock: [require("@/assets/clock.png"), 244, 163],
  syncPeople: [require("@/assets/time.png"), 228, 152],
  syncUpload: [require("@/assets/upload.png"), 228, 152],
} as const;
